...
// 错误对象的封装，给错误封装了Code值，code值标识错误类型.
...
class SystemError extends Error {
  constructor(key, context) {
    const prefix = getMessage(key, []);// 直接返回key键值对应的messages
    ...
    super(message);
    Object.defineProperty(this, kInfo, {  // 新增kInfo属性
      configurable: false,
      enumerable: false,
      value: context
    });
    Object.defineProperty(this, kCode, { // 新增kCode属性
      configurable: true,
      enumerable: false,
      value: key,
      writable: true
  ...
  get name() {
    return `SystemError [${this[kCode]}]`; // 获取错误名称
  }

  set name(value) {
    defineProperty(this, 'name', {  // 设置错误名称
      configurable: true,
      enumerable: true,
      value,
      writable: true
